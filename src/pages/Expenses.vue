  ...
  <div class="container mt-5">
    ...
    <form @submit.prevent="addExpense" class="row g-3">
      ...
      <div class="col-md-4">
        ...
        />
        <!-- Lista de sugerencias: se muestra solo si hay resultados -->
      ...
      <!-- Campo para ingresar producto manualmente en caso de no encontrarlo o no seleccionar ninguno -->
      <div class="col-md-4" v-if="!newExpense.productId">
        <label class="form-label">Nombre Gasto (ingresar manualmente):</label>
        <input
...
export default {
  ...
  setup() {
    ...
    // Objeto para registrar el gasto
    ...
    // Función para cargar los gastos registrados para el turno actual
    ...
    // Función para agregar un gasto y actualizar el inventario si es aplicable
    const addExpense = async () => {
      ...
      // Determinar el nombre del producto o gasto
      ...
      await addDoc(expensesCol, {
        ...
        productName,  // Guardamos el nombre
      ...
      // Si se seleccionó un producto (para actualización de inventario), actualizar stock
